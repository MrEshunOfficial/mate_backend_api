...
export class TaskController {
  ...
  public searchTasks;
  public getAcceptedTasksForProvider;
  ...
  constructor() {
    ...
    // Provider Interactions
    this.expressProviderInterest =
      this.providerInteractionHandler.expressProviderInterest;
    this.withdrawProviderInterest =
      this.providerInteractionHandler.withdrawProviderInterest;
    this.requestProvider = this.providerInteractionHandler.requestProvider;
    this.providerRespondToTask =
      this.providerInteractionHandler.providerRespondToTask;
    ...
    this.getMatchedTasksForProvider =
      this.discoveryHandler.getMatchedTasksForProvider;
    this.getPendingRequestsForProvider =
      this.discoveryHandler.getPendingRequestsForProvider;
    this.getTasksWithProviderInterest =
      this.discoveryHandler.getTasksWithProviderInterest;
    this.searchTasks = this.discoveryHandler.searchTasks;
    this.getAcceptedTasksForProvider =
      this.discoveryHandler.getAcceptedTasksForProvider;
